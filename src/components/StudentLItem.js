  ...
  return (
    <View className="flex-row border justify-center ">
      ...
      <TouchableOpacity className="p-3 my-auto" onPress={() => handleCheck("times")}>
       ...
       {check ? <View className="mx-auto justify-center"><Icon name={info} size={20} color="black"></Icon></View >: <View className="mx-auto justify-center"><Icon name={status == "var" ? ("check" ): status == "izinli" ? ("info"):("times") } size={20} color="blue"></Icon></View >      }
    </View>
  );
};
