    ...
    return (
        <SafeAreaView>
            ...
            <SelectList
                ...
                setSelected={(value) => {
                    if (value !== "Diğer") {
                        setInspectionName(value);
                    } else {
                        setInspectionName(""); // Diğer seçildiğinde inspectionName'i boş bırakıyoruz.
                    }
                    setNewInspection(value); // Bu değer "Diğer" için bile güncelleniyor.
                }}
            ...
            <View className="items-center mt-20">
                {newInspection === "Diğer" && (
                    <SignBlocks placeholder={"Yoklama İsmi Giriniz"} changeFunc={(value) => setInspectionName(value)} />
                )}
                <TouchableOpacity
